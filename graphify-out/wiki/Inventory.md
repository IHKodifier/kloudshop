...
> God node · 62 connections · [E:\Non_Office\Dev_Space\vibe_skool\kloudShop\backend\modules\inventory\models.py](file:///E:/Non_Office/Dev_Space/vibe_skool/kloudShop/backend/modules/inventory/models.py#L39)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as Inventory
    ...
    participant P207 as test_pos_sale_success()
    participant P208 as test_analytics_needs_attention()
    participant P209 as test_pos_sale_insufficient_stock()
    participant P210 as update_product()
    participant P211 as Test end-to-end checkout: payment-intent -> confirm -> inventory decrement.
    participant P212 as create_product()
    participant P213 as test_order_checkout_flow()
    participant P214 as test_stock_transfer()
    participant P215 as test_insufficient_stock()
    participant P216 as receive_purchase_order()
    participant P217 as receive_stock_transfer()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
...
- [[receive_purchase_order()]] `INFERRED`
- [[receive_stock_transfer()]] `INFERRED`
