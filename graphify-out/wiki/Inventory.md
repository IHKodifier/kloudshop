...
> God node · 61 connections · [E:\Non_Office\Dev_Space\vibe_skool\kloudShop\backend\modules\inventory\models.py](file:///E:/Non_Office/Dev_Space/vibe_skool/kloudShop/backend/modules/inventory/models.py#L39)
...
sequenceDiagram
    ...
    participant P199 as test_pos_sale_success()
    participant P200 as test_analytics_needs_attention()
    participant P201 as test_pos_sale_insufficient_stock()
    participant P202 as update_product()
    participant P203 as Test end-to-end checkout: payment-intent -> confirm -> inventory decrement.
    participant P204 as create_product()
    participant P205 as test_order_checkout_flow()
    participant P206 as test_stock_transfer()
    participant P207 as test_insufficient_stock()
    participant P208 as receive_purchase_order()
    participant P209 as receive_stock_transfer()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
