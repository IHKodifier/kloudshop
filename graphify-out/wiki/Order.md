...
> God node · 50 connections · [E:\Non_Office\Dev_Space\vibe_skool\kloudShop\backend\modules\orders\models.py](file:///E:/Non_Office/Dev_Space/vibe_skool/kloudShop/backend/modules/orders/models.py#L9)
...
sequenceDiagram
    ...
    participant P144 as Product
    participant P145 as StockLocation
    participant P146 as Inventory
    ...
    participant P205 as Test end-to-end checkout: payment-intent -> confirm -> inventory decrement.
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
