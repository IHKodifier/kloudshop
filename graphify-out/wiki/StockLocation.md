...
```mermaid
sequenceDiagram
    participant P0 as StockLocation
    ...
    participant P214 as test_purchase_order_lifecycle()
    participant P215 as test_stock_transfer()
    participant P216 as test_insufficient_stock()
    participant P217 as test_assign_staff_location()
    participant P218 as create_location()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
