...
final forceRefreshClaimsProvider = NotifierProvider<ForceRefreshClaims, bool>(ForceRefreshClaims.new);
  ...
  return authState.when(
    data: (user) async {
      ...
      try {
        ...
        if (forceRefresh) {
          Future.microtask(() => ref.read(forceRefreshClaimsProvider.notifier).toggle(false));
        }
