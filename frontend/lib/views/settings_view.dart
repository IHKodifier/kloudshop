...
class _SettingsViewState extends ConsumerState<SettingsView> {
      ...
      body: settingsAsync.when(
        data: (settings) {
          if (_nameController.text.isEmpty && !_isSaving) {
            ...
            _senderEmailController.text = cfg['sender_email'] as String? ?? 'notifications@kloudshop.com';
            _accountEmailController.text = cfg['account_email'] as String? ?? 'merchant@company.com';
            _streetController.text = cfg['street_address'] as String? ?? '1420 Alpine Heights Rd';
            ...
            _selectedIndustry = cfg['industry'] as String? ?? 'Luxury Apparel & Gear';
            _selectedCurrency = cfg['currency'] as String? ?? 'USD';
            _selectedTimezone = cfg['timezone'] as String? ?? 'GMT-05:00 Eastern Time';
        ...
        loading: () => Center(
          child: Column(
            ...
            children: [
              ...
              Text('Loading store settings...', style: theme.textTheme.bodyMedium),
            ],
          ),
        ),
        error: (e, s) => Center(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              const Icon(LucideIcons.settings2, size: 24, color: AppTheme.brandEmerald500),
          ...
          Row(
            children: List.generate(3, (index) {
              ...
              final icons = [LucideIcons.sidebar, LucideIcons.layoutGrid, LucideIcons.smartphone];
              return Padding(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Row(
            children: [
              const Icon(LucideIcons.beaker, size: 16, color: Color(0xFFEC4899)),
              const SizedBox(width: 8),
              Text(
                'Demo Utilities',
                style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold, color: const Color(0xFFEC4899)),
              ),
              ...
              HoverScale(
                child: OutlinedButton.icon(
                  ...
                  label: const Text('Seed Demo Data', style: TextStyle(fontSize: 12)),
  ...
  Widget _buildZurichSidebarLayout(ThemeData theme, bool isDark, tenantSettings) {
    final sidebarItems = [
    ...
    return Row(
      ...
      children: [
        ...
        Container(
          width: 250,
          decoration: BoxDecoration(
            color: isDark ? const Color(0xFF0F172A).withOpacity(0.5) : const Color(0xFFF9FAFB),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: InkWell(
                        onTap: () => setState(() => _zurichSidebarIndex = index),
                        borderRadius: BorderRadius.circular(8),
                        child: Container(
                          padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                          decoration: BoxDecoration(
                            color: isSelected 
                                ? AppTheme.brandEmerald500.withOpacity(isDark ? 0.15 : 0.08)
                                : Colors.transparent,
                            borderRadius: BorderRadius.circular(8),
                          ),
                          child: Row(
                            children: [
                              Icon(
                                ...
                                size: 16, 
                                color: isSelected ? AppTheme.brandEmerald500 : theme.hintColor
                              ),
                              const SizedBox(width: 12),
                              Text(
                                ...
                                style: theme.textTheme.bodyMedium?.copyWith(
                                  fontWeight: isSelected ? FontWeight.bold : FontWeight.normal,
                                  color: isSelected ? AppTheme.brandEmerald500 : theme.colorScheme.onSurface,
                                ),
                              ),
                            ],
                          ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Expert Support',
                        style: theme.textTheme.labelMedium?.copyWith(fontWeight: FontWeight.bold, color: AppTheme.brandEmerald500),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Contacting Specialist...')));
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: AppTheme.brandEmerald500,
                            foregroundColor: Colors.white,
            ...
            _PremiumSection(
              ...
              children: [
                ...
                _buildDropdownRow(
                  ...
                  items: const ['Luxury Apparel & Gear', 'Home & Sustainable Living', 'High-Performance Technology'],
                  onChanged: (v) => setState(() => _selectedIndustry = v!),
                ),
                const SizedBox(height: 16),
                _ReadOnlyRow(
                  label: 'Created On',
                  value: DateFormat('MMMM dd, yyyy').format(tenantSettings.createdAt),
                ),
              ],
            ),
          ],
            ...
            _PremiumSection(
              ...
              children: [
                ...
                _buildDropdownRow(
                  ...
                  items: const ['GMT-05:00 Eastern Time', 'GMT-08:00 Pacific Time', 'GMT+01:00 Central Europe', 'GMT+00:00 London'],
                ...
                _ReadOnlyRow(
                  ...
                  value: tenantSettings.supportedLocales.isNotEmpty ? tenantSettings.supportedLocales.first : 'en',
                ),
              ],
            ),
          ],
        ...
        return Column(
          ...
          children: [
            _PremiumSection(
              ...
              children: [
                _ReadOnlyRow(label: 'Project ID', value: tenantSettings.gcpProjectId ?? 'Not set'),
                const SizedBox(height: 16),
                _ReadOnlyRow(label: 'Asset Bucket', value: tenantSettings.gcpBucketName ?? 'Not set'),
              ],
            ),
          ],
        );
        ...
        return Column(
          ...
          children: [
            _PremiumSection(
              ...
              children: [
                _EditableRow(label: 'Sender Email', controller: _senderEmailController),
                const SizedBox(height: 16),
                _EditableRow(label: 'Account Email', controller: _accountEmailController),
              ],
            ),
          ],
        );
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(LucideIcons.layoutGrid, size: 22, color: AppTheme.brandEmerald500),
              const SizedBox(width: 12),
              Text(
          ...
          Wrap(
            ...
            children: [
              ...
              _buildBentoCard(
                ...
                isDark: isDark,
                children: [
                  _EditableRow(label: 'Street Address', controller: _streetController),
                  const SizedBox(height: 12),
                  Row(
                    children: [
                      Expanded(child: _EditableRow(label: 'City', controller: _cityController)),
                      const SizedBox(width: 8),
                      Expanded(child: _EditableRow(label: 'ZIP', controller: _postalController)),
                    ],
                  ),
                ],
              ),
  ...
  Widget _buildCompactMobileStackLayout(ThemeData theme, bool isDark, tenantSettings) {
    return SingleChildScrollView(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ExpansionTile(
                leading: const Icon(LucideIcons.store, color: AppTheme.brandEmerald500),
                title: const Text('Store Identity', style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              ExpansionTile(
                leading: const Icon(LucideIcons.globe, color: Color(0xFFF59E0B)),
              ...
              const Divider(height: 1),
              ExpansionTile(
                leading: const Icon(LucideIcons.cloud, color: Color(0xFF6366F1)),
                title: const Text('Cloud Storage & GCP', style: TextStyle(fontWeight: FontWeight.bold)),
                childrenPadding: const EdgeInsets.all(16),
                children: [
                  _ReadOnlyRow(label: 'Project ID', value: tenantSettings.gcpProjectId ?? 'Not set'),
                  const SizedBox(height: 12),
              ...
              ExpansionTile(
                ...
                title: const Text('Physical Address', style: TextStyle(fontWeight: FontWeight.bold)),
                childrenPadding: const EdgeInsets.all(16),
                children: [
                  ...
                  const SizedBox(height: 12),
                  _EditableRow(label: 'ZIP Code', controller: _postalController),
                ],
              ),
            ],
          ),
